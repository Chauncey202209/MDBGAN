...
def get_arguments():
    ...
    parser.add_argument('--num_layer', type=int, help='number of layers per stage', default=1)
    ...
    parser.add_argument('--train_depth', type=int, help='how many layers are trained if growing', default=1)
